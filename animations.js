...
gsap.from(".descriptionFloat", {opacity:0, duration: 1, scrollTrigger: ".separator", ease: "power3.inOut" });
...
gsap.from(".floatBtn2", {x:200,opacity:0, duration: 1, scrollTrigger: "#trigger2", ease: "power3.In" });
gsap.from(".floatBtn3", {x:-200,opacity:0, duration: 1, scrollTrigger: "#trigger2", ease: "power3.In" });
gsap.from(".descriptionFloat3", {y:200,opacity:0, duration: 1, scrollTrigger: "#trigger3", ease: "power3.inOut" });
gsap.from(".descriptionFloat4", {y:200,opacity:0, duration: 1, scrollTrigger: "#trigger3", ease: "power3.inOut" });
